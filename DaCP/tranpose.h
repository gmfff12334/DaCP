                      ...
                      )
{
    ...
    for(i=0;i<m;i++)
    {
        ...
        //if(m<end)
          //  end=m;
        element_n=csrRowPtr[i+1]-csrRowPtr[i];
        //avg_element_n = ((double)element_n)/(end-i);
        if(element_n>10){
            if(!xx){
                warp_num[k]=row;
            ...
            warp_greater++;
            warp_num[k]=row;
            //printf("warp_level%d================%d",k,warp_num[k]);
            k++;
            ptr=0;
        }else{   
            xx=0;      
            ...
            if(ptr>=32){
                ...
                warp_lower++;
                warp_num[k]=row;
                //printf("thread_level================%d",warp_num[k]);
                k++;
                ptr=0;
            }
        }
